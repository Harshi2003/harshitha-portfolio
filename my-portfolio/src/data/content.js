...
export const research = [
  ...
  {
    role: "Research Assistant — Speech Emotion Recognition",
...
export const experience = [
  {
    ...
    points: [
      ...
      "Reduced manual lookup work by 30% by converting recurring operational questions into grounded retrieval, validated context, reusable agent tools, deterministic workflow steps, and backend actions that users could complete independently.",
